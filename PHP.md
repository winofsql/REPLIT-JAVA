| API ( PHP ) | CSS | [PHP](README.md#-php--java--python) | [GitHub](#-github-よりインストール-) | HTML | [JavaScript](#-その他-) | jQuery |
| --- | --- | --- | --- | --- | --- | --- |
| [Ajax](#-ajax-)<br>[API](#-api--jsonを返す--)<br><br><br><br><br><br><br><br><br><br><br> | [CSS](#-css-)<br><br><br><br><br><br><br><br><br><br><br><br> | 🔸[特殊](#-特殊php-)<br>🔸[画像](#-画像処理-)<br>🔸[SQLite3](#-sqlite3-)<br><br>📘 [PHP](#-php-)<br><br><br><br><br><br><br><br> | 🔸[掲示板(text)](#-php-git--掲示板mvc-掲示板--テキストファイル-)<br>🔸[掲示板(db)](#-php-git--掲示板mvc掲示板--データベース-)<br>🔸[マスタメンテ](#-php-git--pdo--sqlite--マスタメンテ-14種類--)<br>🔸[問合せ](#-php-git--pdo--sqlite--問い合わせ-10種類--うち2つは-ajax-)<br>🔸[アップロード](#-php-git--アップロード-)<br>🔸[TCPDF](#-php-git--tcpdf-)<br><br><br><br><br><br><br> | 🔸[入力](#-入力-)<br><br>📘 [HTML](#-html-要素-)<br><br><br><br><br><br><br><br><br><br> | 🔸[Basic](#-javascript--basic-)<br>🔸[LocalFile](#-local-file-)<br>🔸[Effect](#-javascript-effect--外部ライブラリ-)<br>🔸[カメラ](#-カメラ-)<br>🔸[特殊](#-特殊js-)<br>　🔹Blackout<br>　🔹Morphing<br>　🔹Fullscreen<br>　🔹Speach<br>　🔹音声認識 <br><br>🔸📘 [JavaScript](#-javascript-) | 🔸[入力要素](#-入力要素-)<br>🔸[jQuery UI](#-jquery-ui-)<br><br>📘 [jQuery](#-jquery--1)<br><br><br><br><br><br><br><br><br> |

- ### 📘 [Shell コマンド](https://qiita.com/kjm_nuco/items/6a4faf4d026d130e7db1)
- ### [📕 Replit で sqlite3 コマンドを使用する](https://replit.com/@sworc/sqlite3-command)
...
- ### 📗 PHP ......... [Java](https://github.com/winofsql/REPLIT-Java-PHP-js-Python/blob/main/README.md) ......... [Python](https://github.com/winofsql/REPLIT-JAVA/blob/main/python.md)
  ...
  - ### ✅ JavaScript : 機能
    - ### 🔶 Ajax [🔼](#)
      ...
      - [📕 指定したパスのファイル一覧 ( PHP APIセット )](https://replit.com/@sworc/js-ajax-table-php-file-json)
    - ### 🔶 Local-File [🔼](#)
